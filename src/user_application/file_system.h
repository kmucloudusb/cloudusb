...
#define FAT_ENTRY_REMOVED 0xE5
#define FAT_ENTRY_FILENAME_BLANK 0x20
...
#define FAT_ROOT_DIR_FIRST_CLUSTER 2
...
#define FAT_ENTRY_PER_CLUSTER (FAT_CLUSTER_SIZE / FAT_ENTRY_SIZE)
